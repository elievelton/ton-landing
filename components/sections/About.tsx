          ...
          <FadeIn direction="left" delay={0.15}>
            <div>
              ...
              <p className="mt-5 text-base leading-relaxed text-muted-foreground sm:text-lg">
                Meu nome é <strong className="font-bold text-foreground">Elievelto</strong>, trabalho com empresas de máquinas de cartão desde{" "}
                <strong className="font-bold text-foreground">2016</strong>. Ao longo dessa
          ...
          <FadeIn>
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-3 text-sm text-muted-foreground sm:text-base">
                Veja as notas de reputação nos principais canais e os depoimentos de quem usa no dia a dia.
              </p>
            </div>
          </FadeIn>
